                        ...
                        return ListView(
                          children: [
                            ...controller.seances.map((seance) {
                              print('candidate status : ${seance.candidat_status}');
                              print('moniteur_status : ${seance.moniteur_status}');
                              print(' status : ${seance.status}');
                              return Padding(
                                padding: const EdgeInsets.symmetric(vertical: 8.0, horizontal: 16.0),
                                child: EventContainer(
                                  date: '${seance.heureD}-${seance.heureF}',
                                  title: "Séance " + seance.type,
                                  subtitle: (seance.candidat_status == Status.awaiting )||(seance.candidat_status == Status.awaiting && seance.moniteur_status == Status.awaiting)
